...
def authoring_shell(
    ...
    *,
    ...
    top = top_bar(deck, doc) if deck else _placeholder_topbar()
    body = body_for(
        mode, deck, view, doc,
...
def _placeholder_topbar() -> html.Header:
    return html.Header(
        [
            html.Div(
                [
            ...
            html.Div(
                [html.Button([html.I(className="bi bi-filetype-pptx"), "Export PPTX"], id={"type": "qs-export", "loc": "top"}, className="qs-btn-primary", disabled=True)],
                className="qs-top-right",
            ),
        ],
        className="qs-topbar",
