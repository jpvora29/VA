...
Pure layout + deterministic derivations (story-item state, page sections). The live
Dash callbacks in ``studio.authoring_app`` feed it a deck and the current view/overrides.
"""
