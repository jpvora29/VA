...
_JUDGE_SYSTEM = (
    ...
    "then a colon, then the finding ('Manufacturing growth: ...'). KEEP that shape. DROP it only when "
    "the label repeats the column heading rather than naming a thing, or when what follows the colon is "
    "a caption rather than a sentence that could stand without the label.\n"
