...
below IS the legend. Correcting a threshold or a colour is a one-line edit here and
nowhere else.

The names are the brand's own for these swatches, so the constant a reader looks up is the
one the palette calls it.
"""
...
_BANDS: Tuple[Tuple[float, bool, Optional[str]], ...] = (
    (-1.0, True, RED),
    (-0.5, True, YELLOW),
    (-0.2, False, LIGHT_YELLOW),
    (0.2, True, WHITE),
    (0.5, False, LIGHT_GREEN),
    (1.0, False, GREEN),
)

# Every colour the table may paint — what a test asserts a page stays inside.
LEGEND: Tuple[str, ...] = (RED, YELLOW, LIGHT_YELLOW, WHITE, LIGHT_GREEN, GREEN, DARK_GREEN)
